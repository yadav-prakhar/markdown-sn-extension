...
.question { color: #4f4a2f; background-color: #f6f4ea; padding: 8px 12px; border-left: 4px solid #d4cb94; display: block; margin: 8px 0; font-size: 110%; }
</style>
`;
...
`;
  ...
  function wrapWithCodeTags(text) {
    ...
    if (/class="(status|important|success|note|tip|attention|warning|caution|blocker|question)"/.test(text)) {
      css += ALERT_CSS;
    }
